"""
Django settings for Cloud Academic Resource Hub backend.
"""
...
ALLOWED_HOSTS = ["student-cloud-resource-hub-8.onrender.com","127.0.0.1", "localhost"]
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'cloud_resource_hub'),
...
AZURE_CONTAINER_NAME = os.getenv('AZURE_CONTAINER_NAME', 'resources')
